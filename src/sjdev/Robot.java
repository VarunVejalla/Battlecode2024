...
//        comms.writeRatioVal(Mode.OFFENSE, 0);
//        comms.writeRatioVal(Mode.MOBILE_DEFENSE, 13);
...
//        double desiredOffensiveFrac = (double) offensiveRatio / ratioDenom;
    ...
    public void run() throws GameActionException {
        ...
        if(rc.isSpawned()){
            ...
            if (rc.getRoundNum() <= Constants.SETUP_ROUNDS) {
                ...
                // try to do a live switch to offense if you're a mobile defender
    ...
    public void testLog() throws GameActionException {
        ...
        Util.logTroopCounts();
        Util.log("offensiveCOM: " + comms.getPreviousOffensiveCOM());
        Util.log("hello");
